          ...
          <div className="flex items-center min-h-screen px-4 py-8">
            <div className="relative w-full max-w-lg p-4 mx-auto bg-[#ffffff] rounded-lg shadow-lg">
              <div className="flex justify-end">
                <button 
                  onClick={handleClick}
                  className="p-2 text-[#808080] rounded-lg hover:bg-[#e2e8f0]"
                  >
              ...
              <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                ...
                <form onSubmit={handleLogin}>
                  ...
                  <button className="block w-full mt-3 py-3 px-4 text-[#ffffff] text-sm text-center bg-[#0013a6] hover:bg-[#0028be] rounded-lg">
